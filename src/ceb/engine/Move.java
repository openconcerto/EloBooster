...
public class Move {
    ...
    public Move(String from, String to) {
        ...
        // System.out.println("Move.Move()" + from + ":" + fromColumn + "," + fromRow + " -> " + to
        // + ":" + toColumn + "," + toRow);
        ...
        // System.out.println("Move:" + from + "-" + to + " :" + this);
    }
    ...
    public Move(int fromColumn, int fromRow, int toColumn, int toRow, char promotionPiece) {
        ...
        if (promotionPiece == 'N') {
            this.promotionPiece = Chess.KNIGHT;
        }
        if (promotionPiece == 'B') {
            this.promotionPiece = Chess.BISHOP;
        }
        if (promotionPiece == 'R') {
            this.promotionPiece = Chess.ROOK;
        }
        if (promotionPiece == 'Q') {
    ...
    public String getUci() {
        ...
        if (this.isNullMove) {
            ...
            uci += colTo;
            uci += rowTo;
            if (this.promotionPiece == Chess.KNIGHT) {
                uci += "N";
            }
            if (this.promotionPiece == Chess.ROOK) {
                uci += "R";
            }
            if (this.promotionPiece == Chess.QUEEN) {
                uci += "Q";
            }
            if (this.promotionPiece == Chess.BISHOP) {
                uci += "B";
            }
            return uci;
        }
